...
public class Cliente extends UsuarioSGE {
	...
	private boolean ahorroAutomatico; // o acci�n autom�tica o accione por s� solo
	//private Actuador accionParaMejorarEficiencia = new ActuadorApagar();// la orden de "apagar" (podr�a ser acci�n
																		// configurable)
