...
public class TestImportadorDispositivos {
	...
	public void hayLamparaInteligente() {
		...
		// assertEquals(sge.dispositivo.DispositivoInteligente.class,
		// Dispositivos.get(0).getClass());
	}

	@Test
	public void hayMicroondas() {
		assertEquals(true,
				Dispositivos.stream().anyMatch(disp -> disp.getClass() == sge.dispositivo.familia.Microondas.class));
	}
